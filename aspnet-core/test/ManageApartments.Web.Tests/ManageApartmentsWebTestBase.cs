...
{
    public abstract class ManageApartmentsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ManageApartmentsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ManageApartmentsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ManageApartmentsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ManageApartmentsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ManageApartmentsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ManageApartmentsDbContext, Task<T>> func)
        {
            T result;
