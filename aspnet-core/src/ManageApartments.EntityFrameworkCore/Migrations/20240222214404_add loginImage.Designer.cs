...
namespace ManageApartments.Migrations
{
    ...
    [Migration("20240222214404_add loginImage")]
    partial class addloginImage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManageApartments.Domain.Entities.ExpenseType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ManageApartments.Domain.Entities.LoginImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ManageApartments.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ManageApartments.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ManageApartments.Domain.Entities.Expense", b =>
                {
                    ...
                    b.HasOne("ManageApartments.Domain.Entities.ExpenseType", "ExpenseType")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("ManageApartments.Domain.Entities.InvoiceDetail", b =>
                {
                    b.HasOne("ManageApartments.Domain.Entities.Hirer", "Hirer")
